...
public class main {
    public static void main(String[] args) {
        ...
        while (undetectedShipNumber > 0) {
            ...
            char locationViewUpdate = evaluateGuessAndGetThatTarget(guessCoordinates, gameBoard, ship, water, hit, miss);
    ...
    private static char evaluateGuessAndGetThatTarget(int[] guessCoordinates, char[][] gameBoard, char ship, char water, char hit, char miss) {
        String message;
        int row = guessCoordinates[0];
        int col = guessCoordinates[1];
